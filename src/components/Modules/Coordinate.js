...
export const HwaDo = {
  ...
  explanation:
    '광운대학교에서 가장 오래된 건물입니다.\n대학행정실 및 총장실 등이 존재합니다.',
};
...
export const BiMa = {
  ...
  explanation: `북카페 페가수스와, 노트북, 강의실 대여가 가능한 \n광운 MOOC센터가 있습니다. \n"전자정보 공과대학"등 공과대학의 학생들이 이용합니다.`,
};
...
export const OgUi = {
  ...
  explanation:
    '수확,물리학과등 "자연과학대학" 건물이다.\n미디어솔루션 이라는 작은 카페가 있습니다',
};
...
export const YeonGu = {
  ...
  explanation:
    '"광운 정보과학교육원"에서 사용하는 곳이며,\n기타 다양한 교양 수업이 이루어집니다.',
};
...
export const ChamBit = {
  ...
  explanation:
    '광운대학교의 교훈인 "참과 빛"에서 따왔으며,\n"전자정보 공과대학"의 교수님들 연구실이 많이 존재합니다.',
};
...
export const SaeBit = {
  ...
  explanation:
    '"소프트웨어 융합 대학"의 건물입니다.\n광운대학교의 대부분 컴퓨터 관련 수업은 여기서 이루어집니다.',
};
...
export const HanWool = {
  ...
  explanation:
    '"인문사회과학대", "정법대"에서 많이 사용하는 건물입니다.\n주로 인문계열의 학생들이 자주 방문합니다',
};
...
export const NooRi = {
  ...
  explanation: '"경영대", "로봇학부", "ROTC"의 건물입니다.\n본교와의 거리때문에 누리섬으로 불립니다.',
};

export const Anni80 = {
  point: {latitude: 37.6200492658703, longitude: 127.058809656544167},
  coordinate: [
  ...
  explanation:
    '광운대학교 80주년을 기념으로 건설된 건물입니다.\n1층에는 중앙도서관과 푸드코트가 있고, \n2층에는 카페와 쉼터가 존재합니다.',
};
