...
function getPhotoFile() {
  ...
  fetch('http://172.30.1.42:3000/routes/getPhotos', {
    method: 'POST',
...
function _onRefresh() {
  // 랭킹 갱신하기
  fetch('http://172.30.1.42:3000/routes/getUsersRank', {
    method: 'GET',
  })
    .then((res) => {
      return res.json();
...
const RankTab = (props) => {
  ...
  useEffect(() => {
    ...
    fetch('http://172.30.1.42:3000/routes/getPhoto', {
      method: 'POST',
      headers: {'Content-Type': 'application/json'},
          ...
          <View style={styles.userInfoContainer}>
            {userPhoto.filename != 'default' ? (
              <Thumbnail
                ...
                large
                source={{
                  uri: `http://172.30.1.42:3000/${userPhoto.filename}`,
                }}></Thumbnail>
            ) : (
          ...
          <View style={{alignItems: 'center', width: '30%'}}>
            ...
            {rankers.rank2.photoState ? (
              <Thumbnail
                circular={true}
                source={{
                  uri: `http://172.30.1.42:3000/${rankers.rank2.filename}`,
                }}
                large
                style={{
                  width: 75,
          ...
          <View style={{alignItems: 'center', width: '40%'}}>
            ...
            {rankers.rank1.photoState ? (
              <Thumbnail
                ...
                large
                source={{
                  uri: `http://172.30.1.42:3000/${rankers.rank1.filename}`,
                }}
          ...
          <View style={{alignItems: 'center', width: '30%'}}>
            ...
            {rankers.rank3.photoState ? (
              <Thumbnail
                ...
                large
                source={{
                  uri: `http://172.30.1.42:3000/${rankers.rank3.filename}`,
                }}
                  ...
                  <View
                    ...
                    {ranker.photoState ? (
                      <Thumbnail
                        ...
                        small
                        source={{
                          uri: `http://172.30.1.42:3000/${ranker.filename}`,
                        }}></Thumbnail>
                    ) : (
                      <Thumbnail
                        circular={true}
