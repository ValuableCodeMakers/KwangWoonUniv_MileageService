...
const RankTab = (props) => {
  ...
  useEffect(() => {
    ...
    fetch('http://172.30.1.48:3000/routes/getPhoto', {
      method: 'POST',
  ...
  // 유저 랭크 가져오기
  // useEffect(() => {
  //   fetch('http://172.30.1.48:3000/routes/getUsersRank', {
  //     method: 'GET',
  //   })
  //     .then((res) => {
  //       return res.json();
              ...
              <Fragment>
                <View style={styles.userRankContainer}>
                  ...
                  <Thumbnail
                    circular={true}
                    source={{
                      uri: `http://172.30.1.48:3000/${userPhoto.filename}`, // 여기서 ? : 사용해서 있으면 서버에서 가져오고 없으면 기본 이미지 사용
                    }}></Thumbnail>
